...
# 存储路径
save_file ='C:/code/pythonScript/images/'

# 精简一下网址，去掉网址中无意义的参数
url_init_first = 'https://image.baidu.com/search/flip?tn=baiduimage&word='
# url_init_first = 'https://cn.bing.com/images/trending?form=HDRSC2'
# 表头
headers = {
...
def down_pic(pic_urls: List[str], max_download_images: int) -> None:
    ...
    for i, pic_url in enumerate(pic_urls):
        try:
            ...
            image_output_path = save_file + str(i + 1121) + '.jpg'
